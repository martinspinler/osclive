...
from .uc import UCInputChannel, UCChannel, UCStudioLiveDevice
...
class SLUcBackend(SLBackend):
    def __init__(self, device: UCStudioLiveDevice, host: str, port: Optional[int] = None, name: str = "SL-Remote", ident: str = "1BE8DC6BF62EA577B") -> None:
        super().__init__()
        self.device = device
